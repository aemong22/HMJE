...
![사용자](Output/assets/사용자.png)

- 하루 총합 맞은단어, 틀린단어, 세모는 자동으로 초기화

### 회원가입

![회원가입](Output/assets/회원가입.png)
