...
function MyPageSection1V1({nickname, nowbadgeName, expWidth, exp, totalExp, sentence, level, level2, nowbadgeImage, userId, dataLevel, checkEmoState}:Type):JSX.Element {  
  ...
  return (
    <>
      ...
      <div className="container max-w-screen-xl h-[30rem] md:w-[90%] mx-auto hidden md:flex flex-col md:flex-row md:justify-around items-center text-center mb-2 bg-[#F0ECE9]">
        <div className="flex flex-col md:w-[55%] h-full rounded-tr-xl rounded-tl-xl " onClick={clickCat}>
          <div className="flex justify-center items-center w-full h-full  ">
            <div className="w-[90%] h-[90%] bg-white py-4 px-4">
              {character}
            </div>
          </div>
