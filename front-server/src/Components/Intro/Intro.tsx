...
function IntroSection1(): JSX.Element {
  return (
    <div
      id="introSection1"
      className="flex justify-between items-center bg-[#D6B17A] text-white h-[30rem] px-4 sm:px-2"
    >
      {/* 왼쪽 */}
      <div className="flex justify-between sm:justify-center items-center w-1-2 sm:w-1/2 md:w-2/5 ">
        <div>
          ...
          <div className="flex justify-start mb-3 ">
            <div className="w-[5.5rem] sm:w-[7rem] md:w-[8rem] h-[2.5rem] flex justify-center items-center border-2 rounded-xl text-base sm:text-lg md:text-xl mr-2 cursor-pointer">
              입장하기
            </div>
            <div className="w-[5.5rem] sm:w-[7rem] md:w-[8rem] h-[2.5rem] flex justify-center items-center border-2 rounded-xl text-base sm:text-lg md:text-xl cursor-pointer">
              가입하기
            </div>
          </div>
        </div>
      ...
      <div className="flex justify-between sm:justify-center items-center w-1/2 sm:w-1/2 lg:w-2/5 xl:w-2/5 ">
        <img
          className="h-[18rem] sm:h-[21rem] md:h-[23rem] xl:h-96"
