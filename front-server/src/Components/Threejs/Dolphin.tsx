...
function Model() {
  ...
  const { nodes, materials, animations }:any = useGLTF('/ThreeFile/Dolphin.gltf')
    ...
    <group ref={group} dispose={null}>
      <group name="Scene">
        <group name="Rig">
          ...
          <skinnedMesh name="Mesh" geometry={nodes.Mesh.geometry} material={materials.M_Dolphin} skeleton={nodes.Mesh.skeleton} />
        </group>
      </group>
    </group>
  )
