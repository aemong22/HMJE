...
function Default({motion}:any) {
  const group = useRef<any>()
  const { nodes, materials, animations }:any = useGLTF('/ThreeFile/Default.gltf')
...
function Dazed({motion}:any) {
  const group = useRef<any>()
  const { nodes, materials, animations }:any = useGLTF('/ThreeFile/Dazed.gltf')
  // console.log('애니메이션',animations[0]);
